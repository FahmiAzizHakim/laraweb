...
@section('content')
  <div class="card card-default">
    <div class="card-header">
      <h3 class="card-title">Edit Package &mdash; {{ $data->package_name }}</h3>
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-10">
          <form action="{{ url('/master/package/'.$data->id) }}" method="POST">
            @csrf
            @method('PUT')
            @include('pages.admin.master.package._form', ['data' => $data])
