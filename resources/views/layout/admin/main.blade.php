...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="{{ asset('webassets/img/gls/gls-bold.png') }}" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <span class="d-block text-white text-bold">
            {{ $authUser->name }}
        	</span>
					<span class="d-block text-white text-xs">
            {{ $authUser->email }}
        	</span>
        </div>
      </div>
      ...
      <div class="container-fluid pt-3">
        ...
        @if (session('failed'))
          <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <i class="icon fas fa-ban"></i> {{ session('failed') }}
          </div>
        @endif
      </div>
    @endif
...
<script>
  ...
  $(function () {
    ...
    }).buttons().container().appendTo('dtgenerals_wrapper .col-md-6:eq(0)');
  });
</script>
@yield('script')
</body>
